<template>
  <section id="log-in" class="flex justify-center min-h-screen items-center" style="background: url()
  ;background-size: contain;" >
    <form @submit.prevent="login" v-if="!isLoading" class="bg-white shadow-md border-black rounded overflow-hidden w-96 p-8">
      <div class="mb-8">
        <h1 class="text-3xl block text-center font-semibold mt-5">
...
const login = async () => {
  ...
  try {
    ...
    // Assuming your API returns 'access' and 'refresh' tokens
    ...
    alert('Invalid credentials, please try again.'); // Handle error appropriately
  } finally {
